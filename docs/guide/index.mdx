...
| express-basic-ts    | Node.js | [Open with StackBlitz](https://stackblitz.com/github/dev-rashedin/servest/tree/main/packages/create-servest/templates/express/express-basic-ts?file=app.ts)    |
| express-mvc-cjs     | Node.js | [Open with StackBlitz](https://stackblitz.com/github/dev-rashedin/servest/tree/main/packages/create-servest/templates/express/express-mvc-cjs?file=app.js)     |
| express-mvc-esm     | Node.js | [Open with StackBlitz](https://stackblitz.com/github/dev-rashedin/servest/tree/main/packages/create-servest/templates/express/express-mvc-esm?file=app.js)     |
| express-mvc-ts      | Node.js | [Open with StackBlitz](https://stackblitz.com/github/dev-rashedin/servest/tree/main/packages/create-servest/templates/express/express-mvc-ts?file=app.ts)      |
| express-modular-cjs | Node.js | [Open with StackBlitz](https://stackblitz.com/github/dev-rashedin/servest/tree/main/packages/create-servest/templates/express/express-modular-cjs?file=app.js) |
| express-modular-esm | Node.js | [Open with StackBlitz](https://stackblitz.com/github/dev-rashedin/servest/tree/main/packages/create-servest/templates/express/express-modular-esm?file=app.js) |
| express-modular-ts  | Node.js | [Open with StackBlitz](https://stackblitz.com/github/dev-rashedin/servest/tree/main/packages/create-servest/templates/express/express-modular-ts?file=app.ts)  |

...
```bash
npm create servest@latest servest-project -- --template express-modular-mjs
```
...
![express-modular-mjs](/images/express-modular-mjs.png)
...
[Open express-modular-mjs on StackBlitz](https://stackblitz.com/github/dev-rashedin/servest/tree/main/packages/create-servest/templates/express/express-modular-mjs?file=src/app.js)

# express-mvc-esm Template

A **JavaScript** backend template following the **MVC (Model-View-Controller)** pattern with **Express.js** using **ES Modules (ESM)**. Includes structured folders for models, views, controllers, configuration, middlewares, and utilities — ideal for organized and scalable backend projects.
...
```bash
npm create servest@latest servest-project -- --template express-mvc-esm
```
...
[Open express-mvc-esm on StackBlitz](https://stackblitz.com/github/dev-rashedin/servest/tree/main/packages/create-servest/templates/express/express-mvc-esm?file=src/app.js)

...
A **TypeScript** backend template following the **MVC (Model-View-Controller)** pattern with **Fastify**. Includes structured folders for models, controllers, routes, services, middlewares, and utilities — ideal for organized and scalable backend projects.
...
![fastify-mvc-ts](/images/fastify/fastify-mvc-ts.png)

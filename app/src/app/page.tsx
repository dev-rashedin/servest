...
export default function HomePage() {
  return (
    <section className="min-h-[70vh] max-w-3xl  mx-auto flex flex-col items-center justify-center text-center ">
      <h1
        className="text-5xl lg:text-7xl font-heading font-bold mb-7 tracking-wide hover:glow"
        style={{ lineHeight: '1.1' }}
      >
        The Ultimate Backend Builder
      </h1>
      <p className="md:max-w-2xl md:text-[16px] lg:text-xl font-medium text-muted-foreground  leading-8 lg:leading-9">
